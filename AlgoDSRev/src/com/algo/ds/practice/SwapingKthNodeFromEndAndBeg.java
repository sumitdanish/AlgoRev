...
public class SwapingKthNodeFromEndAndBeg {
	 ...
	 * 1. we are travelling from 1st node to the kth node; and then we are going kth node from last node
	 * 2. Then we are saving previous link of the node which is in kth node and same is from last node i.e (see list_1 and list_2)
	 * 3. then we implementing logic of swapping the address of node; we can also by swapping the data (Not good idea)
	 * 
	 * 
	 * 
	 * 
