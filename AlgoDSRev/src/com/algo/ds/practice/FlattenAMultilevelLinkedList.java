...
public class FlattenAMultilevelLinkedList {
	...
	public static void main(String[] args) {
		...
		try
		{
		    ...
		    sc.close();
		    String[] childFileName = {"child1.txt","child2.txt","child3.txt","child4.txt","child5.txt","child6.txt","child7.txt"};
		    Node[] childNode = {child1,child2,child3,child4,child5,child6,child7};
