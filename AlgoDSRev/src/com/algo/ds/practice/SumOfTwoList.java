...
public class SumOfTwoList {
	...
	/*This is the sum of list when first node is least significant digit and roght most digit is most significant digit*/
	...
	/*This is the sum of the two list when first node is most significant digit and last node is become least significant
	 * ALgo
	 * 1. We will call recursively and we will store sum until we will reach to the end of the both list 
	 * 2. After reaching the end of the list we will flow the carry to the left of the newly created list;
	 * 
	 * 
	 * */
	...
	private Node addNodeValueOfSameSizeList(Node list,Node list1,int carry)
	{
		try
		{
			...
			{
				int sum=0;
				newList.setNextNode(addNodeValueOfSameSizeList(list.getNextNode(), list1.getNextNode(), carry));
